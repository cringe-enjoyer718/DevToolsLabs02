...
namespace Northwind.Web.Tests.TestDataGenerators
{
    public class CategoryGenerator: ITestDataGenerator<Category>
    {
        ...
        public CategoryGenerator WithProducts(ProductGenerator productGenerator, params Product[] products)
        {
            faker.RuleFor(c => c.Products, () => products);
            return this;
        }

        public CategoryGenerator WithProducts(ITestDataGenerator<Product> generator, 
            int count = 1)
        {
