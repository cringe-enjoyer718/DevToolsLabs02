...
namespace AddressBook.Tests.Windows
{
    public class MainWindow : Window
    {
        ...
        public MenuItem NewContact =>
            Menu
            .FindFirstChild(cf => cf.ByAutomationId("_newContactButton"))
            .AsMenuItem();

        public MenuItem Delete =>
            Menu
            .FindFirstChild(cf => cf.ByAutomationId("_deleteContactButton"))
            .AsMenuItem();

        public TextBox SearchTextBox =>
            FindFirstDescendant(cf => cf.ByAutomationId("_wordwheel"))
            .As<TextBox>();
